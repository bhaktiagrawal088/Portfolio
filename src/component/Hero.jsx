        ...
        <section id='home' className='pt-28 lg:pt-36'> 
            <div className='container lg:grid lg:grid-cols-2 items-center lg:gap-10'>
                ...
                <div className='hidden lg:block'>
                    ...
                    <figure className='w-full max-w-[480px] ml-auto bg-gradient-to-t from-sky-400 via-sky-400/40 t0-65% rounded-[60px] overflow-hidden'>
                        <img src='/Images/hero-banner.png'
                        width={656} height={800} alt='Bhakti Agrawal'
                            className='w-full'
                        />
                    </figure>
                </div>
