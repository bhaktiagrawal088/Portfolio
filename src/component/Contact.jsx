            ...
            <div className='mb-12 lg:mb-0 lg:flex lg:flex-col'>
                ...
                <div className='flex items-center gap-2 mt-auto'>
                    ...
                    {socialLinks.map(({href, icon }, key) => (
                        <a key={key} href={href} target='_blank' className='w-12 h-12  grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-colors, color] hover:bg-zinc-50  hover:text-zinc-950 active:bg-zinc-50/80'>{icon}</a>
                    ))}
                </div>
            </div>

            <form action='https://getform.io/f/alljpzpa' method='POST' className='xl:pl-10  2xl:pl-20'>
                <div className='md:grid md:items-center md:grid-cols-2 md:gap-2'>
                    <div className=' mb-4'>
                        <label htmlFor='name' className='label'>Name</label>
                        <input type='text' name='name' id='name' autoComplete='name' required 
                        placeholder='Enter your name' className='text-field'>
                    ...
                    <div className='mb-4'>
                        ...
                        placeholder='Enter your email' className='text-field'>
